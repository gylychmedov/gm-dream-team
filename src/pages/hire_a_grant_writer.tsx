        ...
        <div className="mx-auto max-w-5xl py-32 sm:py-20 lg:py-36 px-3 sm:px-5">
          <div className="">
            <h1 className="text-center text-4xl font-bold tracking-tight text-white sm:text-6xl">
              <span>{t("navigation:hire_a_grant_writer")}</span>
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-300">
              {t("hire_a_grant_writer_1")}
            </p>

            <p className="mt-6 text-lg leading-8 text-gray-300">
              {t("hire_a_grant_writer_2")}
            </p>

            <p className="mt-6 text-lg leading-8 text-gray-300">
              {t("hire_a_grant_writer_3")}
            </p>

            <p className="mt-6 text-lg leading-8 text-gray-300">
              {t("hire_a_grant_writer_4")}
            </p>

            <p className="mt-6 text-lg leading-8 text-gray-300">
              {t("hire_a_grant_writer_5")}
            </p>

            <p className="mt-6 text-lg leading-8 text-gray-300">
              {t("hire_a_grant_writer_6")}
            </p>

            <p className="mt-6 text-lg leading-8 text-gray-300">
              {t("hire_a_grant_writer_7")}
            </p>
            <p className="mt-6 text-lg leading-8 text-gray-300">
              {t("hire_a_grant_writer_8")}
            </p>

            <p className="mt-6 text-lg leading-8 text-gray-300">
              {t("hire_a_grant_writer_9")}
            </p>

            <p className="mt-6 text-lg leading-8 text-gray-300">
              {t("hire_a_grant_writer_10")}
            </p>

            <p className="mt-6 text-lg leading-8 text-gray-300">
              {t("hire_a_grant_writer_11")}
            </p>
            <p className="mt-6 text-lg leading-8 text-gray-300">
              {t("hire_a_grant_writer_12")}
            </p>
            <p className="mt-6 text-lg leading-8 text-gray-300">
              {t("hire_a_grant_writer_13")}
            </p>
